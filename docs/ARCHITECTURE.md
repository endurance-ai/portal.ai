...
대시보드: Genome / Analytics / Eval / Search Debugger / Products / User Voice / Pipeline Health / Crawl Coverage / **Brand Graph** / **Brand Proposals**.
...
- Lib: `src/lib/eval/` — pure functions (NDCG/Precision) + DB orchestrators (PostgREST 경유)
