...
패션 인플루언서의 룩을 따라 사고 싶을 때 사용자는 브랜드를 모르거나, 알더라도 상품 검색에 시간이 걸린다. portal.ai는 Instagram 포스트 URL 한 장을 입력받아 Vision AI로 아이템을 감지하고, v4 가중합 검색(10개 차원)으로 실제 구매 가능한 상품 링크까지 연결한다. 별도 앱 설치 없이 웹에서 즉시 사용할 수 있다.
