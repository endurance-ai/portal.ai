...
**최종 갱신:** 2026-05-10
**작업 디렉터리:** `/Users/hansangho/Desktop/kikoai/app`
...
kiko.ai 검색 품질을 끌어올리기 위해 **브랜드 간 유사도 그래프(`brand_similar`)** 구축. 활용:
1. "비슷한 브랜드 추천" 신기능
...
| 2 | brand normalization 책임 | **(A)** kiko.ai 안에서 cleanup |
| 3 | 이미지 임베딩 트랙 | **(A)** 텍스트 임베딩 우선. 이미지는 별 트랙 |
| 4 | 텍스트 임베딩 백본 | **BGE-m3** 로컬 (1024차원, 한/영 강함) |
| 5 | 임베딩 호스팅 | **(α)** 사용자 Mac 1회 → 안정화 후 kikoai/ai로 이전 검토 |
...
- `umap-learn`, `python-dotenv`, `openai` (uv add — kikoai/ai)
